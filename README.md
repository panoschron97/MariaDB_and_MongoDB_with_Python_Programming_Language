I wrote code in Python programming langauge answering queries using two databases with the help of a menu. The data is on the website **https://www.kaggle.com/datasets/yelp-dataset/yelp-dataset**.
